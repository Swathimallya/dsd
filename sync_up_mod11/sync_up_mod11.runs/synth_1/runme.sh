...
HD_PWD='C:/Users/swath/sync_up_mod11/sync_up_mod11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_up_mod11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_up_mod11.tcl

...
HD_PWD='C:/Users/swath/sync_up_mod11/sync_up_mod11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_up_mod11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sync_up_mod11.tcl -notrace

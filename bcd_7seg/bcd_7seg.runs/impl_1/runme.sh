...
HD_PWD='C:/Users/swath/bcd_7seg/bcd_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_7seg.tcl -notrace

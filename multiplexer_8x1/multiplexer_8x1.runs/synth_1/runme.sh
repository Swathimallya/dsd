...
HD_PWD='C:/Users/swath/multiplexer_8x1/multiplexer_8x1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_8x1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexer_8x1.tcl

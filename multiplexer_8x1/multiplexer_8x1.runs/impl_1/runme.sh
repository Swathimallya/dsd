...
HD_PWD='C:/Users/swath/multiplexer_8x1/multiplexer_8x1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_8x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplexer_8x1.tcl -notrace

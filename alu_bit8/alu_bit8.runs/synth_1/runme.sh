...
HD_PWD='C:/Users/swath/alu_bit8/alu_bit8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_bit8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_bit8.tcl

...
HD_PWD='C:/Users/swath/alu_bit8/alu_bit8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_bit8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_bit8.tcl -notrace

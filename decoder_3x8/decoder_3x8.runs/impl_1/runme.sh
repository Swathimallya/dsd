...
HD_PWD='C:/Users/swath/decoder_3x8/decoder_3x8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_3x8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_3x8.tcl -notrace

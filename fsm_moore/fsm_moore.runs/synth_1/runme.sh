...
HD_PWD='C:/Users/swath/fsm_moore/fsm_moore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_moore.tcl

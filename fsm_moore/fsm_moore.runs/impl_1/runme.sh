...
HD_PWD='C:/Users/swath/fsm_moore/fsm_moore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_moore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_moore.tcl -notrace

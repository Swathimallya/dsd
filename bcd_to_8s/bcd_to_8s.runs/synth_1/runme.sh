...
HD_PWD='C:/Users/swath/bcd_to_8s/bcd_to_8s.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_to_8s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_to_8s.tcl

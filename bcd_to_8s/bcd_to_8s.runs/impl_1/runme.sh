...
HD_PWD='C:/Users/swath/bcd_to_8s/bcd_to_8s.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_to_8s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_to_8s.tcl -notrace

...
HD_PWD='C:/Users/swath/encoder_8x3/encoder_8x3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8x3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_8x3.tcl -notrace

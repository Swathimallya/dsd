...
HD_PWD='C:/Users/swath/squarer_3bits/squarer_3bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log squarer_3bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source squarer_3bits.tcl -notrace

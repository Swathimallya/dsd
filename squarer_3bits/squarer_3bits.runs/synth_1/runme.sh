...
HD_PWD='C:/Users/swath/squarer_3bits/squarer_3bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log squarer_3bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source squarer_3bits.tcl
